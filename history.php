...
<head>
	...
	<title>User Recent Requests</title>
...
<body>
	<?php
		if(isset($_POST['Cancel'])){
			...
			if ($r) {
				echo " <script> alert('Your Have Deleted the Request ID : $request'); window.location.href = 'history.php' </script>";
			}
			else{echo "Failed";}
		}?>
<input type="checkbox" id="nav-toggle" >
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li><a href="history.php" class="active"><span class="las la-history"></span><span>History</span></a></li>
	...
	<main><?php
				$of = $_SESSION['user_id'];
				$show = "SELECT * FROM requests WHERE id_of_requester = '$of' AND status = 'completed' ";
		 ...
		 ?>
				...
				<td><form method="post">
					...
					<input type="submit" name="Cancel" value="Delete" >
								...
								<?php } }else{ ?> <div class="nothing"><?php echo "No Completed Pickups";?></div><?php } }  ?>
							</tbody>
						</table>
					</div>
					</div>
